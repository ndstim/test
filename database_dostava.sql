...
--
-- Host: localhost    Database: dostava
-- ------------------------------------------------------
...
CREATE TABLE `kupac` (
  ...
  `dostavljeno` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `kupac` VALUES (1,'Nebojsa','066011444','Fruskogorska','1918-11-22','napomena za ',0);
...
-- Dump completed on 2018-11-21 15:51:21
